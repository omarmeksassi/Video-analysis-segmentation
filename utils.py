...
<a target='_blank'
  href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/us-central1/3839994332228616192?project=ai-media25mun-306&deploy=true'>
  Vertex AI Studio
...
<ul style="list-style-position: outside; margin-left: 1em;">
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-videoanalysisandsegmentat-1-17465280472/source?project=ai-media25mun-306'
    >
      source code editor
  ...
  <li>Go to your
    <a target='_blank'
       href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/us-central1/3839994332228616192?project=ai-media25mun-306'
    >
  ...
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-videoanalysisandsegmentat-1-17465280472/security?project=ai-media25mun-306'
    >
      Security settings
